...
class DiffableTableViewModel {
    ...
    private func buildCatalogCards() {
        ...
        let familySectionModel = SectionModel(title: "Family", rows: [
            ...
            RowModel(name: "Pallavi", detail: "xxx@gmail.com", type: .B),
            RowModel(name: "Chandana Hosamane", detail: "xxx@gmail.com", type: .B),
            RowModel(name: "Renuka", detail: "xxx@gmail.com", type: .B),
            RowModel(name: "Nijaguna M", detail: "xxx@gmail.com", type: .B),
            RowModel(name: "Keerthana B", detail: "xxx@gmail.com", type: .B)
        ])
